...
@section('content')
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        ...
                        <a class="nav-link active" aria-current="page" href="{{url('view/users')}}"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    @if(Auth::check() == "true")
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('view/products')}}"><i class=""></i> <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-view-list" viewBox="0 0 16 16">
    ...
    <div class="form-login-cadastro row">
        ...
        <div class="login col-6">
            ...
            <form class="form form-login" action="{{url('view/register/user')}}" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                @method('POST')
