...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        @if(Auth::user()->name == "administradpr")
                        <a class="nav-link active" aria-current="page" href="{{url('visualizacao/usuarios')}}"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('visualizacao/produtos')}}"><i class=""></i> <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-view-list" viewBox="0 0 16 16">
    ...
    <div class="form-login-cadastro row">
        ...
        <div class="login col-6">
            <div class="h1-login">
                <h1 class="text-center" id="title-form"> Cadastrar  </h1>
            </div>
            <form class="form form-login" action="{{url('visualizacao/cadastrar/usuario')}}" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                @method('POST')
                <label id="label-create-login"> Nome: </label>
                <input id="inputs" type="text" name="name" placeholder="Digite seu nome" class="form-control"
                ...
                <input id="inputs" type="password" name="password_confirmation" placeholder="Digite sua senha" class="form-control"
                       value="" required>
                @if(isset($errors) && count($errors) > 0 )
                    @foreach($errors->get('password') as $error)
                        <b><span class="text-danger"> {{$error}}</span></b>
