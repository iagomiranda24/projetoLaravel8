...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{url('view/home')}}">
    ...
    <div class="card text-center bg-transparent container">
        ...
        <div class="card-body">
            ...
            <p class="card-text">.</p>
            <a href="{{url("view/users")}}" class="btn btn-primary"> Ir para usuários</a>
        </div>
    </div>
    <br>
    ...
    <div class="card text-center bg-transparent container">
        ...
        <div class="card-body">
            ...
            <p class="card-text">.</p>
            <a href="{{url('view/products')}}" class="btn btn-primary"> Ir para produtos</a>
        </div>
    </div>
    <br>
